...
<html lang="en">
    <head>
        ...
        <!-- App title -->
        <title>Newsportal | Update Commercial</title>
                        ...
                        <div class="row">
							<div class="col-xs-12">
								<div class="page-title-box">
                                    <h4 class="page-title">Update Commercial Image </h4>
...
<!-- Current Top Commercial image -->

 <div class="row">
<div class="col-sm-12">
 <div class="card-box">
<h4 class="m-b-30 m-t-0 header-title"><b>Current Top Commercial Image</b></h4>
<img src="topaddimages/<?php echo htmlentities($row['PostImage']);?>" width="300"/>
<br />
